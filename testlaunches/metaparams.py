...
from project.networks.losses import *
...
losses_functions = [RelativeError(), MaxAbsoluteDeviation(), MyMSE()]
...
def get_loss_func_name(loss_func):
    return str(loss_func)[str(loss_func).rfind('.') + 1:str(loss_func).find(' object')]
